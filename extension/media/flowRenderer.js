(function() {
    ...
    try {
    var dataEl = document.getElementById("flowDataStore"); var flowData = decodeFlowData(dataEl.getAttribute("data-flow"));
    var historyTrail = decodeFlowData(dataEl.getAttribute("data-history"));
